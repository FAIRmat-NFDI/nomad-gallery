...
from nomad.metainfo import Quantity, SchemaPackage, MEnum
...
class GalleryEntry(Schema):
    ...
    research_field = Quantity(
        type=str,
        description=' The specific scientific domain (e.g., Battery Science, Catalysis).',
        a_eln=ELNAnnotation(component=ELNComponentEnum.StringEditQuantity)
    )

    description = Quantity(
        type=str,
        description='Project description, research question, and how NOMAD was integrated.',
    ...
    methodology_type = Quantity(
        ...
        description='Whether the work is primarily computational, experimental, or both.',
